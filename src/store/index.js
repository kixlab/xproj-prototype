...
export default new Vuex.Store({
  state: {
    ...
    district: 0,
    districts: {
      'seoul': ['전체', '강남구 갑', '강남구 병', '강남구 을', '강동구 갑', '강동구 을', '강북구 갑', '강북구 을', '강서구 갑', '강서구 병', '강서구 을', '관악구 갑', '관악구 을', '광진구 갑', '광진구 을', '구로구 갑', '구로구 을', '금천구', '노원구 갑', '노원구 병', '노원구 을', '도봉구 갑', '도봉구 을', '동대문구 갑', '동대문구 을', '동작구 갑', '동작구 을', '마포구 갑', '마포구 을', '서대문구 갑', '서대문구 을', '서초구 갑', '서초구 을', '성북구 갑', '성북구 을', '송파구 갑', '송파구 병', '송파구 을', '양천구 갑', '양천구 을', '영등포구 갑', '영등포구 을', '용산구', '은평구 갑', '은평구 을', '종로구', '중구·성동구 갑', '중구·성동구 을', '중랑구 갑', '중랑구 을'],
